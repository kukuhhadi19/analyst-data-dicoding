...
import streamlit as streamlitconfigshow
...
sns.barplot(x="product_count", y="product_category_name_english",
            data=sum_order_items_df.head(5), palette="Set2", ax=ax[0])
...
sns.barplot(x="product_count", y="product_category_name_english", data=sum_order_items_df.sort_values(
    by="product_count", ascending=True).head(5), palette="Set2", ax=ax[1])
...
st.caption('Copyright (C) Kukuh Hadi S. 2024')
